...
type softborneFormatChecker struct{}

func (checker softborneFormatChecker) IsFormat(input string) bool {
	// TODO(vdaviot): implement format here when step one is done
	return true
}
...
func init() {
	...
	gojsonschema.FormatCheckers.Add("softborne", softborneFormatChecker{})
}
